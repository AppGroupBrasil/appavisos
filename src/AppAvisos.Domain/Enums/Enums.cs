...
public enum TipoMensagem { Aviso = 1, Comunicado = 2, Informativo = 3, Notificacao = 4, Documento = 5 }
public enum AutorMensagem { Sindico = 1, Morador = 2 }
public enum TemplateAviso { Padrao = 1, Urgente = 2, Manutencao = 4 }
public enum CategoriaReporte { Ocorrencia = 1, Manutencao = 2, Reclamacao = 3, Sugestao = 4, Solicitacao = 5, SegundaViaBoleto = 6, Informacao = 7, Outro = 99 }
public enum StatusReporte { Aberto = 1, EmExecucao = 2, Finalizado = 3, Arquivado = 4, EmAnalise = 5 }
